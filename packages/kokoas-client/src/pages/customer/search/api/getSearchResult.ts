...
import { advancedSearchCustGroup } from './advancedSearchCustGroup';
...
export const getSearchResult = async (params : AdvancedSearchCustGroupParam) => {

  const records = await advancedSearchCustGroup(params);
